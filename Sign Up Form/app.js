...
document.querySelector('.x-btn').addEventListener('click',()=>{
  ...
  document.querySelector('.container').style.cssText = 'background: linear-gradient(rgba(0,0,0,0),rgba(0,0,0,.7)),url(images/img1.jpg) center no-repeat;background-size: cover;';
});